...
Task.create(title: 'Register for courses', start: DateTime.new(2021, 11, 9), due: DateTime.new(2021, 11, 9))
...
Task.create(title: 'Drink more water', start: DateTime.new(2021, 11, 12),  due: DateTime.new(2021, 12, 11))
...
Task.create(title: 'Physics HW', description: 'boring', start: DateTime.new(2021, 11, 3),
            due: DateTime.new(2021, 11, 4), complete: true)
Task.create(title: 'Write Capybara tests', description: 'not boring', start: DateTime.new(2021, 11, 3),
            due: DateTime.new(2021, 11, 3))
Task.create(title: 'Put away christmas decorations', due: DateTime.new(2022, 0o1, 7), complete: true)
User.create!(email: 'spike2@colgate.edu', password: 'supersecure')
>>>>>>> main
