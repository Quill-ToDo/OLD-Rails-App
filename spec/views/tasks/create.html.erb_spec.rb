...
RSpec.describe 'create page', type: :view do
  ...
  it 'should allow a user to create a task if signed in' do
    ...
    fill_in 'Start Date and Time', with: '11/18/2021 4:22 PM'
    fill_in 'End Date and Time', with: '11/19/2021 4:22 PM'
  ...
  it 'should not allow a user to create a task with a start date after the due date' do
    ...
    fill_in 'Description', with: 'description'
    fill_in 'Start Date and Time', with: '11/19/2021 4:22 PM'
    fill_in 'End Date and Time', with: '11/18/2021 4:22 PM'
    click_on 'Create task'
